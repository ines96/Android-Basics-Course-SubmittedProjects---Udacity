    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.list_item_res, parent, false);
        }

        // Get the {@link Local} object located at this position in the list
        Local currentLocal = getItem(position);

        // Find the TextView in the list_item_res.xml.xml layout with the ID title_text_view.
        ...
        // Find the TextView in the list_item_res_res.xml layout with the ID phonenumber_text_view.
        TextView phonenumberTextView = (TextView) listItemView.findViewById(R.id.phonenumber_text_view);
        ...
        // Find the TextView in the list_item_res_res.xml layout with the ID hours_text_view.
        ...
        // Find the TextView in the list_item_res_res.xml layout with the ID food_text_view.
        TextView foodTextView = (TextView) listItemView.findViewById(R.id.food_text_view);
        // Get the foodtype from the currentLocal object and set this text on
        // the foodtype TextView.
        foodTextView.setText(currentLocal.getFoodTypeId());

        // Find the ImageView in the list_item_res_res.xml layout with the ID image.
